...
public class MainActivity extends AppCompatActivity implements RadioGroup.OnCheckedChangeListener, OnClickListener {
    ...
    private void displayToast( double temperature ) {
        ...
        if(temperature > 50)
            ...
            Toast.makeText(this, "Nice weather we're having.", Toast.LENGTH_LONG).show();
        else
    ...
    public void onClick(View v) {
        ...
        //If the user chooses Kelvin, convert to Fahrenheit and Celsius and display in those text boxes
        if(btnKel.isChecked()) {
